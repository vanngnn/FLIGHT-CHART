    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <asp:GridView ID="DAILYOUTPUT_DOCK4_REGISTER" runat="server"  AutoGenerateColumns="false" DataKeyNames="Id_all_output" class="table table-bordered table-striped" OnRowDataBound="DAILYOUTPUT_DOCK4_REGISTER_RowDataBound" >
                                <Columns>
