...
{
    public partial class DAILYOUTPUT_DOCK4 : System.Web.UI.Page
    {
        int Id_Planta;
        ...
        private void CargarGrid()
        {
            ...
            DAILYOUTPUT_DOCK4_REGISTER.DataSource = RegistroDAL.dockQueryOutput(dockName);
            DAILYOUTPUT_DOCK4_REGISTER.DataBind();
        }
        public void ObtenerWidgets()
        {
            try
            {
                ...
                Registro Reg = RegistroDAL.ObtenerRegistros_shipment_dock_output("Dock 4");
                if (Reg == null)
                {
                    lblEntiempo.Text = "0";
                    lblAtrasado.Text = "0";
        ...
        protected void DAILYOUTPUT_DOCK4_REGISTER_RowDataBound(object sender, GridViewRowEventArgs e)
        {
