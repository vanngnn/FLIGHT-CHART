...
{
    public partial class DASHBOARD_DOCK2 : System.Web.UI.Page
    {
        int Id_Planta;
        ...
        private void CargarGrid()
        {
            ...
            DASHBOARD_DOCK2_REGISTER.DataSource = RegistroDAL.ListDashboard_Dock(dockName);
            DASHBOARD_DOCK2_REGISTER.DataBind();
        }
        public void ObtenerWidgets()
        {
            try
            {
                ...
                Registro Reg = RegistroDAL.ObtenerRegistros_dashboard_dock("Dock 2");
                if (Reg == null)
                {
                    lblEntiempo.Text = "0";
                    lblAtrasado.Text = "0";
        ...
        protected void DASHBOARD_DOCK2_REGISTER_RowDataBound(object sender, GridViewRowEventArgs e)
        {
