...
{
    public partial class DASHBOARD_DOCK6 : System.Web.UI.Page
    {
        int Id_Planta;
        ...
        private void CargarGrid()
        {
            ...
            DASHBOARD_DOCK6_REGISTER.DataSource = RegistroDAL.ListDashboard_Dock(dockName);
            DASHBOARD_DOCK6_REGISTER.DataBind();
        }
        public void ObtenerWidgets()
        {
            try
            {
                ...
                Registro Reg = RegistroDAL.ObtenerRegistros_dashboard_dock("Dock 6");
                if (Reg == null)
                {
                    lblEntiempo.Text = "0";
                    lblAtrasado.Text = "0";
        ...
        protected void DASHBOARD_DOCK6_REGISTER_RowDataBound(object sender, GridViewRowEventArgs e)
        {
