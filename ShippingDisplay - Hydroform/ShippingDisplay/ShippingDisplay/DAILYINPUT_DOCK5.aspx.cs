...
{
    public partial class DAILYINPUT_DOCK5 : System.Web.UI.Page
    {
        int Id_Planta;
        ...
        {
            string dockName = "Dock 5";  // Specify the dock name here
            DAILYINPUT_DOCK5_REGISTER.DataSource = RegistroDAL.dockQueryInput(dockName);
            DAILYINPUT_DOCK5_REGISTER.DataBind();
        }
        public void ObtenerWidgets()
        {
            try
            {
                ...
                Registro Reg = RegistroDAL.ObtenerRegistros_shipment_dock_input("Dock 5");
                if (Reg == null)
                {
                    lblEntiempo.Text = "0";
                    lblAtrasado.Text = "0";
        ...
        protected void DAILYINPUT_DOCK5_REGISTER_RowDataBound(object sender, GridViewRowEventArgs e)
        {
