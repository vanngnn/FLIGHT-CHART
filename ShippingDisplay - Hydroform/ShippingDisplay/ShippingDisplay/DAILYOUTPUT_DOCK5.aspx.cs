...
{
    public partial class DAILYOUTPUT_DOCK5 : System.Web.UI.Page
    {
        int Id_Planta;
        ...
        private void CargarGrid()
        {
            ...
            DAILYOUTPUT_DOCK5_REGISTER.DataSource = RegistroDAL.dockQueryOutput(dockName, 1);
            DAILYOUTPUT_DOCK5_REGISTER.DataBind();
        }
        ...
        protected void DAILYOUTPUT_DOCK5_REGISTER_RowDataBound(object sender, GridViewRowEventArgs e)
        {
