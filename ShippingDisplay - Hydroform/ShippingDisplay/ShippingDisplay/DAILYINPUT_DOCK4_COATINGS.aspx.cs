...
{
    public partial class DAILYINPUT_DOCK4_COATINGS : System.Web.UI.Page
    {
        int Id_Planta;
        ...
        private void CargarGrid()
        {
            ...
            DAILYINPUT_DOCK4_REGISTER_COATINGS.DataSource = RegistroDAL.dockQueryInput_coatings(dockName);
            DAILYINPUT_DOCK4_REGISTER_COATINGS.DataBind();
        }
        public void ObtenerWidgets()
        {
            try
            {
                ...
                Registro Reg = RegistroDAL.ObtenerRegistros_shipment_dock_input_coatings("Dock 4");
                if (Reg == null)
                {
                    lblEntiempo.Text = "0";
                    lblAtrasado.Text = "0";
        ...
        protected void DAILYINPUT_DOCK4_REGISTER_COATINGS_RowDataBound(object sender, GridViewRowEventArgs e)
        {
