<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dashboard_COATINGS.aspx.cs" Inherits="ShippingDisplay.ShippingDisplay.Dashboard_COATINGS" %>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <asp:GridView ID="gvRegistros" runat="server"  AutoGenerateColumns="false" DataKeyNames="Id_all_coatings" class="table table-bordered table-striped" OnRowDataBound="gvRegistros_RowDataBound" >
                                <Columns>
