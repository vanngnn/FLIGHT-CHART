﻿<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DAILYINPUT_DOCK5.aspx.cs" Inherits="ShippingDisplay.ShippingDisplay.DAILYINPUT_DOCK5" %>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <asp:GridView ID="DAILYINPUT_DOCK5_REGISTER" runat="server"  AutoGenerateColumns="false" DataKeyNames="Id_all" class="table table-bordered table-striped" OnRowDataBound="DAILYINPUT_DOCK5_REGISTER_RowDataBound" >
                                <Columns>
