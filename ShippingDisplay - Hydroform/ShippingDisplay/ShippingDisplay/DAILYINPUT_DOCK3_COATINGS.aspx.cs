...
{
    public partial class DAILYINPUT_DOCK3_COATINGS : System.Web.UI.Page
    {
        int Id_Planta;
        ...
        private void CargarGrid()
        {
            ...
            DAILYINPUT_DOCK3_REGISTER_COATINGS.DataSource = RegistroDAL.dockQueryInput_coatings(dockName);
            DAILYINPUT_DOCK3_REGISTER_COATINGS.DataBind();
        }
        public void ObtenerWidgets()
        {
            try
            {
                ...
                Registro Reg = RegistroDAL.ObtenerRegistros_shipment_dock_input_coatings("Dock 3");
                if (Reg == null)
                {
                    lblEntiempo.Text = "0";
                    lblAtrasado.Text = "0";
        ...
        protected void DAILYINPUT_DOCK3_REGISTER_COATINGS_RowDataBound(object sender, GridViewRowEventArgs e)
        {
