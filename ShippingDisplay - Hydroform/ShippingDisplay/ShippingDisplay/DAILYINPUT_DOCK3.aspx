﻿<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DAILYINPUT_DOCK3.aspx.cs" Inherits="ShippingDisplay.ShippingDisplay.DAILYINPUT_DOCK3" %>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <asp:GridView ID="DAILYINPUT_DOCK3_REGISTER" runat="server"  AutoGenerateColumns="false" DataKeyNames="Id_all" class="table table-bordered table-striped" OnRowDataBound="DAILYINPUT_DOCK3_REGISTER_RowDataBound" >
                                <Columns>
