﻿<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DAILYOUTPUT_DOCK5.aspx.cs" Inherits="ShippingDisplay.ShippingDisplay.DAILYOUTPUT_DOCK5" %>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <asp:GridView ID="DAILYOUTPUT_DOCK5_REGISTER" runat="server"  AutoGenerateColumns="false" DataKeyNames="Id_all_output" class="table table-bordered table-striped" OnRowDataBound="DAILYOUTPUT_DOCK5_REGISTER_RowDataBound" >
                                <Columns>
