...
{
    public partial class DAILYOUTPUT_DOCK1 : System.Web.UI.Page
    {
        int Id_Planta;
        ...
        {
            string dockName = "Dock1";  // Specify the dock name here
            DAILYOUTPUT_DOCK1_REGISTER.DataSource = RegistroDAL.dockQueryOutput(dockName);
            DAILYOUTPUT_DOCK1_REGISTER.DataBind();
        }
        ...
        protected void DAILYOUTPUT_DOCK1_REGISTER_RowDataBound(object sender, GridViewRowEventArgs e)
        {
