...
{
    public partial class DAILYOUTPUT_DOCK3_COATINGS : System.Web.UI.Page
    {
        int Id_Planta;
        ...
        private void CargarGrid()
        {
            ...
            DAILYOUTPUT_DOCK3_REGISTER_COATINGS.DataSource = RegistroDAL.dockQueryOutput_coatings(dockName);
            DAILYOUTPUT_DOCK3_REGISTER_COATINGS.DataBind();
        }
        public void ObtenerWidgets()
        {
            try
            {
                ...
                Registro Reg = RegistroDAL.ObtenerRegistros_shipment_dock_output_coatings("Dock 3");
                if (Reg == null)
                {
                    lblEntiempo.Text = "0";
                    lblAtrasado.Text = "0";
        ...
        protected void DAILYOUTPUT_DOCK3_REGISTER_COATINGS_RowDataBound(object sender, GridViewRowEventArgs e)
        {
