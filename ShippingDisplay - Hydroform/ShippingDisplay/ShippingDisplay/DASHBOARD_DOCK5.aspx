﻿<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DASHBOARD_DOCK5.aspx.cs" Inherits="ShippingDisplay.ShippingDisplay.DASHBOARD_DOCK5" %>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <asp:GridView ID="DASHBOARD_DOCK5_REGISTER" runat="server"  AutoGenerateColumns="false" DataKeyNames="Id_all" class="table table-bordered table-striped" OnRowDataBound="DASHBOARD_DOCK5_REGISTER_RowDataBound" >
                                <Columns>
