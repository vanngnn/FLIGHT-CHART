﻿<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DAILYINPUT_DOCK4_COATINGS.aspx.cs" Inherits="ShippingDisplay.ShippingDisplay.DAILYINPUT_DOCK4_COATINGS" %>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <asp:GridView ID="DAILYINPUT_DOCK4_REGISTER_COATINGS" runat="server"  AutoGenerateColumns="false" DataKeyNames="Id_all" class="table table-bordered table-striped" OnRowDataBound="DAILYINPUT_DOCK4_REGISTER_COATINGS_RowDataBound" >
                                <Columns>
