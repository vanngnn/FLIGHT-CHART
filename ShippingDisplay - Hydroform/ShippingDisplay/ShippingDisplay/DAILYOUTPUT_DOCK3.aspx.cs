...
{
    public partial class DAILYOUTPUT_DOCK3 : System.Web.UI.Page
    {
        int Id_Planta;
        ...
        private void CargarGrid()
        {
            ...
            DAILYOUTPUT_DOCK3_REGISTER.DataSource = RegistroDAL.dockQueryOutput(dockName);
            DAILYOUTPUT_DOCK3_REGISTER.DataBind();
        }
        public void ObtenerWidgets()
        {
            try
            {
                ...
                Registro Reg = RegistroDAL.ObtenerRegistros_shipment_dock_output("Dock 3");
                if (Reg == null)
                {
                    lblEntiempo.Text = "0";
                    lblAtrasado.Text = "0";
        ...
        protected void DAILYOUTPUT_DOCK3_REGISTER_RowDataBound(object sender, GridViewRowEventArgs e)
        {
