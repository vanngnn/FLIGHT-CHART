...
{
    public partial class Dashboard_COATINGS : System.Web.UI.Page
    {
        int Id_Planta;
        ...
        {
            int shipStatus = 1;
            gvRegistros.DataSource = RegistroDAL.ListDashboard_COATINGS(shipStatus);
        ...
        public void ObtenerWidgets()
        {
            try
            {
                ...
                Registro Reg = RegistroDAL.ObtenerRegistros_coatings(Id_Planta);
