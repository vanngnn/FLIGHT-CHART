...
{
    public partial class DAILYINPUT_DOCK6 : System.Web.UI.Page
    {
        int Id_Planta;
        ...
        private void CargarGrid()
        {
            ...
            DAILYINPUT_DOCK6_REGISTER.DataSource = RegistroDAL.dockQueryInput(dockName);
            DAILYINPUT_DOCK6_REGISTER.DataBind();
        }
        public void ObtenerWidgets()
        {
            try
            {
                ...
                Registro Reg = RegistroDAL.ObtenerRegistros_shipment_dock_input("Dock 6");
                if (Reg == null)
                {
                    lblEntiempo.Text = "0";
                    lblAtrasado.Text = "0";
        ...
        protected void DAILYINPUT_DOCK6_REGISTER_RowDataBound(object sender, GridViewRowEventArgs e)
        {
