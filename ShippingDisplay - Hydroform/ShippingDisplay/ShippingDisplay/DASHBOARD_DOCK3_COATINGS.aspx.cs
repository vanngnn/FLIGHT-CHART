...
{
    public partial class DASHBOARD_DOCK3_COATINGS : System.Web.UI.Page
    {
        int Id_Planta;
        ...
        private void CargarGrid()
        {
            ...
            DASHBOARD_DOCK3_REGISTER_COATINGS.DataSource = RegistroDAL.ListDashboard_Dock_COATINGS(dockName);
            DASHBOARD_DOCK3_REGISTER_COATINGS.DataBind();
        }
        public void ObtenerWidgets()
        {
            try
            {
                ...
                Registro Reg = RegistroDAL.ObtenerRegistros_dashboard_dock_coatings("Dock 3");
                if (Reg == null)
                {
                    lblEntiempo.Text = "0";
                    lblAtrasado.Text = "0";
        ...
        protected void DASHBOARD_DOCK3_REGISTER_COATINGS_RowDataBound(object sender, GridViewRowEventArgs e)
        {
