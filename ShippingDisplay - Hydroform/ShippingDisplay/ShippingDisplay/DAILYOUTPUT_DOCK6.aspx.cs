...
{
    public partial class DAILYOUTPUT_DOCK6 : System.Web.UI.Page
    {
        int Id_Planta;
        ...
        public void ObtenerWidgets()
        {
            try
            {
                ...
                Registro Reg = RegistroDAL.ObtenerRegistros_shipment_dock_output("Dock 6");
                if (Reg == null)
                {
                    lblEntiempo.Text = "0";
                    lblAtrasado.Text = "0";
        ...
        protected void DAILYOUTPUT_DOCK6_REGISTER_RowDataBound(object sender, GridViewRowEventArgs e)
        {
