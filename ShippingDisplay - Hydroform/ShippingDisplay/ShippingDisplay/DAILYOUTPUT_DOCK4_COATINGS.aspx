﻿<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DAILYOUTPUT_DOCK4_COATINGS.aspx.cs" Inherits="ShippingDisplay.ShippingDisplay.DAILYOUTPUT_DOCK4_COATINGS" %>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <asp:GridView ID="DAILYOUTPUT_DOCK4_REGISTER_COATINGS" runat="server"  AutoGenerateColumns="false" DataKeyNames="Id_all_output_coatings" class="table table-bordered table-striped" OnRowDataBound="DAILYOUTPUT_DOCK4_REGISTER_COATINGS_RowDataBound" >
                                <Columns>
