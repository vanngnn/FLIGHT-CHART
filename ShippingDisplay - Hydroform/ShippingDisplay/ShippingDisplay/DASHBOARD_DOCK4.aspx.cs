...
{
    public partial class DASHBOARD_DOCK4 : System.Web.UI.Page
    {
        int Id_Planta;
        ...
        private void CargarGrid()
        {
            ...
            DASHBOARD_DOCK4_REGISTER.DataSource = RegistroDAL.ListDashboard_Dock(dockName);
            DASHBOARD_DOCK4_REGISTER.DataBind();
        }
        ...
        protected void DASHBOARD_DOCK4_REGISTER_RowDataBound(object sender, GridViewRowEventArgs e)
        {
