            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <asp:GridView ID="gvRegistros" runat="server"  AutoGenerateColumns="false" DataKeyNames="Id_all_output_coatings" class="table table-bordered table-striped" OnRowCommand="gvRegistros_RowCommand" OnRowDataBound="gvRegistros_RowDataBound">
                                <Columns>
                                    <asp:BoundField HeaderText="ID" DataField="Id_all_output_coatings" Visible="false" />
