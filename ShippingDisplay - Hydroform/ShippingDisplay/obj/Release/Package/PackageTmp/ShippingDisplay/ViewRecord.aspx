...
<body>
    ...
    <script>
            ...
            if (navigator.geolocation) {
                navigator.geolocation.getCurrentPosition(
                    function (position) {
                        ...
                        // Get the part number and table name
                        var shipmentId = document.getElementById('<%= hdnPartNumber.ClientID %>').value;
                        var tableName = getTableName(shipmentId); // Define your logic to get the table name

                        // Call the web method to update the shipment status
                        updateShipmentStatus(shipmentId, tableName);
                    },
                    function (error) {
        ...
        function getTableName(plantName) {
            if (plantName === 'Hydroform') {
                return 'LogOutput';
            } else if (plantName === 'Coatings') {
                return 'LogOutput_coatings';
            }
            return '';
        }
