﻿<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DASHBOARD_DOCK2_COATINGS.aspx.cs" Inherits="ShippingDisplay.ShippingDisplay.DASHBOARD_DOCK2_COATINGS" %>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <asp:GridView ID="DASHBOARD_DOCK2_REGISTER_COATINGS" runat="server"  AutoGenerateColumns="false" DataKeyNames="Id_all_coatings" class="table table-bordered table-striped" OnRowDataBound="DASHBOARD_DOCK2_REGISTER_COATINGS_RowDataBound" >
                                <Columns>
